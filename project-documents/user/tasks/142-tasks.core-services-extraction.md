...
- [x] **1.1: Create `packages/core/src/services/constants.ts`**
...
- [x] **1.2: Create `packages/core/src/services/interfaces.ts`**
...
- [x] **2.1: Copy and update `TemplateProcessor.ts`**
...
- [x] **3.1: Copy and update `SystemPromptParser.ts`**
...
- [x] **4.1: Copy and update `StatementManager.ts`**
...
- [x] **5.1: Copy and update `ProjectPathService.ts`**
...
- [x] **6.1: Copy and update `SectionBuilder.ts`**
...
- [x] **7.1: Create `packages/core/src/services/index.ts`**
...
- [x] **8.1: Run `pnpm --filter @context-forge/core build`**
...
- [x] **8.3: Commit — core build verified**
...
- [x] **9.1: Update `src/services/context/ContextIntegrator.ts`**
...
- [x] **9.2: Update `src/services/context/ContextTemplateEngine.ts`**
...
- [x] **9.3: Update `src/services/context/__tests__/TemplateProcessor.test.ts`**
  - Change `TemplateProcessor` import from `../TemplateProcessor` to `@context-forge/core`
  - **Success**: Import resolves from core

- [x] **9.4: Update `src/main/ipc/contextServices.ts`**
...
- [x] **9.8: Update `src/main/services/context/index.ts`**
...
- [x] **9.9: Commit — consumers updated**
...
- [x] **10.2: Verify no stale imports remain**
...
- [x] **11.3: Check for empty directories**
...
- [x] **13.1: Interactive rebase to squash slice 142 commits**
