...
- [x] **Task 1: Create fixture project directory and files** (Effort: 2/5)
  ...
  - [x] Directory structure matches slice design diagram
  - [x] `projects.json` is valid JSON with all required `ProjectData` fields
  - [x] Statement and prompt files parse correctly (verified in Task 3)

- [x] **Task 2: Create integration test helper module** (Effort: 2/5)
  ...
  - [x] No `any` types
  - [x] `createIntegrationClient` registers all 3 tool groups
  - [x] `setupFixtureEnv` produces a temp dir with patched absolute path
  - [x] File compiles with `pnpm build` in `packages/mcp-server`

- [x] **Task 3: Smoke test — verify fixture + helper wiring** (Effort: 1/5)
  ...
  - [x] Smoke test passes with `pnpm test` in `packages/mcp-server`
...
- [x] **Task 5: `project_list` integration tests** (Effort: 1/5)
  ...
  - [x] All `project_list` tests pass
  - [x] Assertions verify actual field values against fixture data

- [x] **Task 6: `project_get` integration tests** (Effort: 1/5)
  ...
  - [x] All `project_get` tests pass
  - [x] Error case verifies `isError: true` in response

- [x] **Task 7: `project_update` integration tests** (Effort: 2/5)
  ...
  - [x] All `project_update` tests pass
...
- [x] **Task 9: `context_build` integration tests** (Effort: 2/5)
  ...
  - [x] All `context_build` tests pass
  - [x] Output verified to contain fixture project markers
  - [x] Override parameters produce observable changes in output

- [x] **Task 10: `template_preview` integration tests** (Effort: 1/5)
  ...
  - [x] All `template_preview` tests pass
  - [x] Output structure matches `context_build` expectations

- [x] **Task 11: `prompt_list` integration tests** (Effort: 1/5)
  ...
  - [x] All `prompt_list` tests pass
  - [x] Template count matches fixture file sections

- [x] **Task 12: `prompt_get` integration tests** (Effort: 1/5)
...
- [x] **Task 14: `context_summarize` integration tests** (Effort: 2/5)
  ...
  - [x] All `context_summarize` tests pass
  - [x] Mutation tests clean up after themselves
  - [x] Read-back verification confirms persistence
