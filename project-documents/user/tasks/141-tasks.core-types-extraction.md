...
- [x] **1.1: Create `packages/core/src/types/context.ts`**
...
- [x] **1.2: Create `packages/core/src/types/sections.ts`**
...
- [x] **1.3: Create `packages/core/src/types/statements.ts`**
...
- [x] **1.4: Create `packages/core/src/types/prompts.ts`**
...
- [x] **1.5: Create `packages/core/src/types/project.ts`**
...
- [x] **1.6: Create `packages/core/src/types/paths.ts`**
...
- [x] **2.1: Create `packages/core/src/types/index.ts`**
...
- [x] **2.2: Update `packages/core/src/index.ts`**
...
- [x] **4.1**: `src/services/project/ProjectValidator.ts` — `ProjectData`, `CreateProjectData`
- [x] **4.2**: `src/services/project/ProjectManager.ts` — `ProjectData`
- [x] **4.3**: `src/services/project/__tests__/ProjectManager.test.ts` — `ProjectData`
- [x] **4.4**: `src/services/context/ContextIntegrator.ts` — `ProjectData` (also imports context types — handle in Task 5)
- [x] **4.5**: `src/services/context/ContextGenerator.ts` — `ProjectData`
- [x] **4.6**: `src/services/context/__tests__/ContextIntegrator.test.ts` — `ProjectData`
- [x] **4.7**: `src/services/context/__tests__/ContextGenerator.test.ts` — `ProjectData`
- [x] **4.8**: `src/hooks/useContextGeneration.ts` — `ProjectData`
- [x] **4.9**: `src/components/settings/SettingsButton.tsx` — `ProjectData`
- [x] **4.10**: `src/components/settings/SettingsDialog.tsx` — `ProjectData`
- [x] **4.11**: `src/components/project/ProjectSelector.tsx` — `ProjectData`
- [x] **4.12**: `src/components/ContextBuilderApp.tsx` — `CreateProjectData`, `ProjectData`
- [x] **4.13**: `src/components/forms/ProjectConfigForm.tsx` — `CreateProjectData`, `ProjectData`
- [x] **4.14**: `src/components/forms/__tests__/ProjectConfigForm.integration.test.ts` — `ProjectData`, `CreateProjectData`, `UpdateProjectData`
...
- [x] **5.1**: `src/services/context/ContextIntegrator.ts` — `ContextData`, `EnhancedContextData` (merge with ProjectData import from Task 4.4)
- [x] **5.2**: `src/services/context/ContextTemplateEngine.ts` — `EnhancedContextData`, `ContextSection`, `ContextTemplate`
- [x] **5.3**: `src/services/context/TemplateProcessor.ts` — `ContextData`
- [x] **5.4**: `src/services/context/SectionBuilder.ts` — `ContextSection`, `EnhancedContextData`, `SectionBuilderConfig`
- [x] **5.5**: `src/services/context/StatementManagerIPC.ts` — `TemplateStatement`
- [x] **5.6**: `src/services/context/__tests__/TemplateProcessor.test.ts` — `ContextData`
...
- [x] **6.1**: `src/main/services/context/SystemPromptParser.ts` — `SystemPrompt`, `ParsedPromptFile`, `PromptCacheEntry`, `SpecialPromptKeys`
- [x] **6.2**: `src/main/services/context/StatementManager.ts` — `TemplateStatement`, `ParsedStatement`
- [x] **6.3**: `src/main/ipc/contextServices.ts` — `TemplateStatement`
- [x] **6.4**: `src/components/settings/ProjectPathSection.tsx` — `PathValidationResult`
...
- [x] **7.1: Update `src/services/context/index.ts`**
...
- [x] **7.2: Update `src/main/services/context/index.ts`**
...
- [x] **8.1: Delete renderer context type files**
...
- [x] **8.2: Delete main-process context type files**
...
- [x] **8.3: Delete project/storage type files**
...
- [x] **9.1: Run `pnpm --filter @context-forge/core build`**
  - Must succeed with zero errors
  - **Success**: Clean build, `dist/` output present

- [x] **9.2: Run `pnpm --filter @context-forge/electron build`**
  - Must succeed with zero type errors
  - **Success**: Electron app builds, `out/` directory produced

- [x] **9.3: Run `pnpm --filter @context-forge/electron test:run`**
...
- [x] **10.1: Stage and commit all changes**
